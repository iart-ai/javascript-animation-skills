...
2. **Director pass**: the contact sheet at 2 frames per second (`--sheet .5`), scored for pace, framing variety, still frames, whether every action has its sound, and whether it looks grown-up. Do at least two rounds.
